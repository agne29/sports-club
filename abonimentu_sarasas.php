            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="lead section-lead">Sporto klubo abonementai</p>
                        <div class="row">

                            <?php
                            $query = 'SELECT * from abonementai';
//$result = mysql_query( $query);
                            ...
                            echo "<table class='table table-bordered table-striped table-hover'>
                                <thead>
                                    <tr>
                                        <td colspan=9><a href='abonimentai_nauji.php'>Registruoti abonementą</a></td>
                                    </tr>
                                </thead>";
                            ...
                            echo "<tbody>
                                    <tr>
                                        ...
                                        <th class='text-center'>Data nuo</td>
                                        <th class='text-center'>Data iki</td>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td class='text-center'>" . $row['data_nuo'] . "</td>";
                                echo "<td class='text-center'>" . $row['data_iki'] . "</td>";
                                echo "<td class='text-center'>" . $row['kaina'] . "</td>";
                                echo "<td class='text-center'>" . $row['tipas'] . "</td>";
                                echo "<td class='text-center'>" . $row['rusis'] . "</td>";

                                echo "<td class='text-center'><a href=\"abonimentai_keisti.php?id=" . $row['id'] . " \" name='edit' value='Redaguoti'>Redaguoti</a>&nbsp;&nbsp;&nbsp;";
                                echo " <a href=\"abonimentai_trinti.php?id=" . $row['id'] . " \" name='delete' value='Šalinti'>Ištrinti</a>" . "</td>
                                </tr>";
                            }
                            echo "</tbody>
                            </table> ";
