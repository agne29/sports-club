...
if (isset($_POST['login'])) {
    ...
    $elektroninis_pastas1 = mysqli_real_escape_string($con, $_POST['elektroninis_pastas1']);

    $result = mysqli_query($con, "SELECT * FROM administratoriai WHERE elektroninis_pastas1 = '" . $elektroninis_pastas1 . "' and password = '" . md5($password) . "'");

    if ($row = mysqli_fetch_array($result)) {
        $_SESSION['elektroninis_pastas1'] = $row['elektroninis_pastas1'];
                    ...
                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="elektroninis_pastas1" placeholder="Elektroninis paštas" required class="form-control" />
                            </div>
