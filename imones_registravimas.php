...
//check if form is submitted
    if (isset($_POST['registruoti'])) {
        ...
        if (!$error) {
            if (mysqli_query($con, "INSERT INTO imones(pavadinimas,adresas,pasto_kodas,telefonas,elektroninis_pastas,faksas)
            VALUES('" . $pavadinimas . "', '" . $adresas . "', '" . $pasto_kodas . "',
             '" . $telefonas . "', '" . $elektroninis_pastas . "', '" . $faksas . "')")) {
                $successmsg = "Sėkmingai užregistravote įmonę!";
            } else {
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 well">
                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="patalposforma">
                        <fieldset>
                            <legend>Įmonės registracija</legend>

                            <?php imones_registravimas(); ?>
