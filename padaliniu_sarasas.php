            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="lead section-lead">Sporto klubo padaliniai</p>
                        <div class="row">

                            <?php
                            $query = 'SELECT * from padaliniai';
                            ...
                            echo "<table class='table table-bordered table-striped table-hover'>
                                <thead>
                                    <tr>
                                        <td colspan=7><a href='padalinio_registracija.php'>Registruoti naują padalinį</a></td>
                                    </tr>
                                </thead>";
                            ...
                            echo "<tbody>
                                    <tr>
                                        ...
                                        <th class='text-center'>Adresas</td>
                                        <th class='text-center'>Telefonas</td>
                                        <th class='text-center'>Elektroninis paštas</td>
                                        <th class='text-center'>Pašto kodas</td>
                                        <th class='text-center'>Miestas</td>
                                        <th class='text-center'>&nbsp;</td>
                                    </tr>";
                            while ($row = mysqli_fetch_array($result)) {
                                echo "<tr>";
                                echo "<td class='text-center'>" . $row['pavadinimas'] . "</td>";
                                echo "<td class='text-center'>" . $row['adresas'] . "</td>";
                                echo "<td class='text-center'>" . $row['telefonas'] . "</td>";
                                echo "<td class='text-center'>" . $row['elektroninis_pastas'] . "</td>";
                                echo "<td class='text-center'>" . $row['pasto_kodas'] . "</td>";
                                echo "<td class='text-center'>" . $row['miestas'] . "</td>";

                                echo "<td class='text-center'><a href=\"padaliniu_redagavimas.php?numeris=" . $row['numeris'] . " \" name='edit' value='Redaguoti'>Redaguoti</a></td>
                                </tr>";
                            }
                            echo "</tbody>
                            </table> ";
