...
function patalpos_registravimas() {
...
//check if form is submitted
    if (isset($_POST['registruoti'])) {
        ...
        if (!$error) {
            if (mysqli_query($con, "INSERT INTO patalpos(numeris,aukstas,ilgis,plotis,grindu_danga,tipas,fk_padalinys)
            VALUES('" . $numeris . "', '" . $aukstas . "', '" . $ilgis . "', '" . $plotis . "',
             '" . $grindu_danga . "', '" . $tipas . "', '" . $padalinys . "')")) {
                $successmsg = "Sėkmingai užregistravote patalpą! <a href='patalpu_sarasas.php'>Paspauskite, kad grįžtumėte į patalpų sąrašo langą.</a>";
            } else {
    ...
    echo "<div class='form-group'>
                                ...
                                <input type='number' name='numeris' placeholder='Įveskite patalpos numerį (skaičius)' required value='";
    if ($error)
        echo $numeris;
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 well">
                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="patalposforma">
                        <fieldset>
                            <legend>Patalpos registracija</legend>

                            <?php patalpos_registravimas(); ?>
