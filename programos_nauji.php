        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4 well">
                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="programu_registravimas">
                        <fieldset>
                            <legend>Programos registracija</legend>

                            <?php programu_registravimas(); ?>
                            ...
                            function programu_registravimas() {
...
if (isset($_POST['registruoti'])) {
    ...
    if (!$error) {
        if (mysqli_query($con, "INSERT INTO programos(vyksta_nuo, kaina, trukme, tipas, lytis, rusis)
            VALUES('" . $vyksta_nuo . "', '" . $kaina . "', '" . $trukme . "',
             '" . $tipas . "', '" . $lytis . "', '" . $rusis . "')")) {
            $successmsg = "Sėkmingai užregistravote programą! <a href='programu_sarasas.php'>Paspauskite, kad grįžtumėte į programų sąrašo langą.</a>";
        } else {
 ...
 echo "
                            ...
                            <div class='form-group'>
                                ...
                                <input type='date' name='vyksta_nuo' placeholder='Data' required value='";
                                if ($error) 
                                    echo $vyksta_nuo;
