...
if (isset($_POST['delete'])) {
    ...
    mysqli_query($con, "DELETE FROM programos WHERE id='" . $id . "'");
}
?>
<!DOCTYPE html>
<head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="lead section-lead">Sporto klubo programos</p>
                        <div class="row">

                            <?php
                            $query = 'SELECT programos.id, programos.vyksta_nuo, programos.kaina, programos.trukme, programos.tipas, programos.lytis, programos.rusis from programos';
//$result = mysql_query( $query);
                            ...
                            echo "<table class='table table-bordered table-striped table-hover'>
                                <thead>
                                    <tr>
                                        <td colspan=9><a href='programos_nauji.php'>Registruoti programą</a></td>
                                    </tr>
                                </thead>";
                            ...
                            echo "<tbody>
                                    <tr>
                                        ...
                                        <th class='text-center'>Vyksta nuo</td>
                                        <th class='text-center'>Kaina</td>
                                        <th class='text-center'>Trukmė</td>
                                        <th class='text-center'>Tipas</td>
                                        <th class='text-center'>Lytis</td>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td class='text-center'>" . $row['vyksta_nuo'] . "</td>";
                                echo "<td class='text-center'>" . $row['kaina'] . "</td>";
                                echo "<td class='text-center'>" . $row['trukme'] . "</td>";
                                echo "<td class='text-center'>" . $row['tipas'] . "</td>";
                                echo "<td class='text-center'>" . $row['lytis'] . "</td>";
                                echo "<td class='text-center'>" . $row['rusis'] . "</td>";

                                echo "<td class='text-center'><a href=\"programos_keisti.php?id=" . $row['id'] . " \" name='edit' value='Redaguoti'>Redaguoti</a>&nbsp;&nbsp;&nbsp;";
                                echo " <a href=\"programos_trinti.php?id=" . $row['id'] . " \" name='delete' value='Šalinti'>Ištrinti</a>" . "</td>
                                </tr>";
                            }
                            echo "</tbody>
                            </table> ";
