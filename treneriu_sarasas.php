    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="lead section-lead">Sporto klubo treneriai</p>
                <div class="row">
                    ...
                    echo "<table class='table table-bordered table-striped table-hover'>
                                <thead>
                                    <tr>
                                        <td colspan=7><a href='treneriai.php'>Registruoti naują trenerį</a><br>
                    ...
                    echo "<tbody>
                                    <tr>
                                        ...
                                        <th class='text-center'>Tabelio nr</td>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td class='text-center'>" . $row['telefono_numeris'] . "</td>";
                        echo "<td class='text-center'>" . $row['elektroninis_pastas'] . "</td>";
                        echo "<td class='text-center'>" . $row['tabelio_nr'] . "</td>";
                        echo "<td class='text-center'><a href='uzsiemimo_redagavimas.php'>Redaguoti</a></td>
                            </tr>";
                    }
                    echo "</tbody>
                            </table> ";
